...
searchButton.addEventListener('click', function() {
  ...
  fetch('http://www.omdbapi.com/?apikey=f4d69482&s=' + inputKeyword.value)
    ...
    .then(response => {
      ...
      modalDetail.forEach(btn => {
        btn.addEventListener('click', function(){
          ...
          //console.log(imdbID);
          fetch('http://www.omdbapi.com/?apikey=f4d69482&i=' + imdbID)
            .then(response => response.json())
            .then(m => {
...
function getMovieDetail(imdbID) {
  return fetch('http://www.omdbapi.com/?apikey=f4d69482&i=' + imdbID)
          .then(response => response.json())
          .then(m => m);
}
